        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.cusat.ac.in">Don Bosco College of Engineering</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					...
					<p>Goa, India</p>
					<p></p>
					<a href="mailto:soumen1696@gmail.com">naikpranav110803@gmail.com</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; DBCE| Developed by
              <a href="http://znumerique.azurewebsites.net" target="_parent">Sai Rane, Pranav Naik, Ralph Rodrigues</a>
				</div>
